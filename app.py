...
def run_match_simulation(thuis_row, uit_row, odd1, oddX, odd2, runs=5000):
    ...
    match_xg = base_lam_t + base_lam_u
    # We vertalen de odds rechtstreeks naar verwachte doelpunten (lambda), en laten de wiskunde z'n werk doen.
    ...
    for _ in range(runs):
        # Geen while loops meer, gewoon realistisch 1x een score trekken op basis van kracht
